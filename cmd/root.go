...
func init() {
	...
	rootCmd.Flags().StringVarP(&proxyImage, "proxy-image", "i", "ghcr.io/scholzj/kekspose:kroxylicious-0.10.0", "Container image used for the proxy (must be based on a compatible Kroxylicious container image).")
